...
ax.set_title(f'''All Posts’ Character Counts (Top) and Word Counts (Bottom)''', fontweight='bold')
...
boxplot.plot_text(ax,boxes,bp_dict,-5,mode=3)
boxplot.plot_text(ax_words,boxes_words,bp_words_dict,-1,mode=3)
...
plt.savefig('graphs/dual_box_post_character_count_word_count.png',dpi=header.IMG_DPI)
